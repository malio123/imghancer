...
export function Hero({
  ...
  const backgroundSrc =
    'https://pbs.twimg.com/media/G6Nrt-bacAI4NES?format=jpg&name=4096x4096';
  ...
  return (
    <>
      <section
        id={hero.id}
        className={`relative isolate overflow-hidden pt-24 pb-8 md:pt-36 md:pb-8 ${hero.className} ${className}`}
      >
        {/* Background image */}
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
          ...
          />
          <div className="from-background/35 via-background/10 to-background/80 dark:from-background/55 dark:via-background/20 dark:to-background/85 absolute inset-0 bg-gradient-to-b" />
        </div>
